...
public abstract class PostListFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mAdapter = new FirebaseRecyclerAdapter<Post, PostViewHolder>(options) {
            ...
            @Override
            protected void onBindViewHolder(PostViewHolder viewHolder, int position,
                                            final Post model) {
                ...
                viewHolder.bindToPost(model, new View.OnClickListener() {
                    ...
                    public void onClick(View starView) {
                        ...
                        DatabaseReference globalPostRef =
                                mDatabase.child("posts").child(postRef.getKey());
    ...
    private void onStarClicked(DatabaseReference postRef, final String key) {
        postRef.runTransaction(new Transaction.Handler() {
            ...
            public Transaction.Result doTransaction(MutableData mutableData) {
                ...
                if (p.stars.containsKey(getUid())) {
                    ...
                    removeToStar(getUid(), p, key);
                } else {
                    // Star the post and add self to stars
                    p.starCount = p.starCount + 1;
                    p.stars.put(getUid(), true);
                    if (p.uid != getUid())
                        addToStar(getUid(), p, key);
                }
    ...
    private void addToStar(String userId, Post p, String refKey) {
    ...
    private void removeToStar(String userId, Post p, String key) {
        // Create new post at /user-posts/$userid/$postid and at
        // /posts/$postid simultaneously
        mDatabase.child("stars").child(userId).child(key).removeValue();
